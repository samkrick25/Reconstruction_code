...
visualize and plot distributions of endpoints of antIRN/PARN vs postIRN/PARN cells in any region(s)
@author: economolab
"""
...
ccf_v3.add_brain_region('PB', hemisphere='left')
...
fig, axes = plotting_funcs.comp_node_dist(antflat, postflat, labels=['anterior IRN/PARN', 'posterior IRN/PARN'], suptitle = 'Distribution of IRN/PARN endpoints in PB')
...
#5700 is exact midline of ccf axes, but some regions don't get all the way there
