...
#TODO: plot endpoints in V and XII, check for dimorphism between IRN and PARN cells
#621 is V, XII is 773
...
IRNcoords = preprocess_funcs.get_coords(IRNallpoints, dim='all')
PARNcoords = preprocess_funcs.get_coords(PARNallpoints, dim='all')

ccf_scene = Scene(atlas_name='allen_mouse_10um')
ccf_scene.add_brain_region('HY', color='green', alpha=0.1, silhouette=False)
ccf_scene.add_brain_region('TH', color='red', alpha=0.1, silhouette=False)
