# -*- coding: utf-8 -*-
"""
Created on Fri Mar 27 01:21:55 2026
...
ccf_scenesag.add_brain_region('PAG', color='lightpink', alpha=0.3, silhouette=False)
...
direct = r"C:\Data\reconstructions\medulla_IRN_PRN_PGRN\medulla_IRN_PRN_PGRN\swccoordswapped"
neuronlist = []
pngsavedir = r"C:\Users\economolab\Documents\GitHub\Reconstruction_code\images\irnparngrncells\top"
for file, color in tqdm(zip(os.listdir(direct),output),desc='loading Neurons'):
    filestring = file.split('.')[0]
    cellname = filestring[3:]
    if cellname in GRNcelllist:    
...
savefile = r'C:\Users\economolab\Documents\GitHub\Reconstruction_code\images\irnparngrncells\bulksag.png'
ccf_scenesag.screenshot(name=savefile, scale=5, camera=cams.sagcam)
